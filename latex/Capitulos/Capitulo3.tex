...
\begin{figure}[htb]
	\centering
  	...
  	\label{fig:implementacao-funcao-process-pattern}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\label{fig:aplicacao-funcao-process-pattern}
\end{figure}
...
\begin{figure}[htb]
	\centering
  	...
  	\label{fig:implementacao-funcao-specify-linkages}
\end{figure}
...
\begin{figure}[H]
	\centering
  	...
  	\label{fig:aplicacao-funcao-specify-linkages}
\end{figure}
...
A função $get\_match$ é a principal interface para encontrar correspondências de 
uma expressão regular de glicano em uma estrutura de glicano. Ela utiliza as 
funções auxiliares como $preprocess\_pattern$ e $specify\_linkages$ internamente 
...
\begin{figure}[htb]
	\centering
  	...
  	\label{fig:implementacao-da-funcao-get-match}
\end{figure}
